...
![](https://blog.kakaocdn.net/dna/NrGM0/btsI5s7SxMu/AAAAAAAAAAAAAAAAAAAAAA38Ih5jzYNE7DK8vPyx0N7EZw5tShZfb06a5FgtWFAg/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1772290799&allow_ip=&allow_referer=&signature=%2BK95dhZQtvWFIY0Le3ZKl4TIImc%3D)
...
![](https://blog.kakaocdn.net/dna/cY9A7C/btsI6x8yXfi/AAAAAAAAAAAAAAAAAAAAADuhep2TxR4AX2qrtpr5yu7ipgpvx1Cvkh6OD-lEx3Bo/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1772290799&allow_ip=&allow_referer=&signature=ecN0P9Sufmch4%2FMMrMpigNMA%2Fqc%3D)

여기서 F\_s는 공간적 계산 순서로:

![](https://blog.kakaocdn.net/dna/bVXHbs/btsI7JtbsXG/AAAAAAAAAAAAAAAAAAAAADSMF6pL4zv_7H2vIE1WG20G1Vq98vJVEtqwsSBsczp4/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1772290799&allow_ip=&allow_referer=&signature=i1vg01ZGHWPh8j1VR0oQZ2hjwLw%3D)

로 나타내며, 𝐶𝑜𝑛𝑣는 2D 공간 컨볼루션을, 𝐵𝑁은 배치 정규화를, 𝜎는 비선형 활성화 함수 ReLU를, 𝑘는 커널 크기를 의미합니다. 반면, F\_t는 시간적 계산 순서로:

![](https://blog.kakaocdn.net/dna/G48Fg/btsI6uquOi6/AAAAAAAAAAAAAAAAAAAAADhaLQZoE41k7fnazWoBe6GHJ7jskO0XQpoJzMUYb8Bm/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1772290799&allow_ip=&allow_referer=&signature=mzroUXOXwhaVoI%2BoDE3eGRpRRi4%3D)
...
![](https://blog.kakaocdn.net/dna/LbGmE/btsI7ov037u/AAAAAAAAAAAAAAAAAAAAAM-TSt0xs5TOg8M7xPNIqDk3W1wM3DBbthqut8dmlBDr/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1772290799&allow_ip=&allow_referer=&signature=tY%2B8ymF7OLg1lkaHEGKej346x60%3D)
...
![](https://blog.kakaocdn.net/dna/cfWqxj/btsI7UVxIPf/AAAAAAAAAAAAAAAAAAAAAPFak9VBvt_1lUl5x0JyoS_CHmVGpJrHIwTPdeWiRj7g/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1772290799&allow_ip=&allow_referer=&signature=4uTptk2RuFJuFRWDSHTEY9VM2DE%3D)

여기서 𝑑는 일반적으로 키 벡터의 차원을 나타내는 스케일링 계수입니다. 주의 가중치 𝑎𝑖𝑗는 소프트맥스 함수를 사용하여 얻어집니다:

![](https://blog.kakaocdn.net/dna/bS0UIJ/btsI7q1AInn/AAAAAAAAAAAAAAAAAAAAAMWpaGxx82fGomZvwPpYGP8or134XC1RNulUqJAsPk20/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1772290799&allow_ip=&allow_referer=&signature=pYeR474JuQBQm9MGB1XYpLqj9Hk%3D)

이후, 각 쿼리 𝑌𝑖에 대한 출력 벡터는 계산된 주의 가중치로 가중치가 부여된 모든 값 𝑉𝑗를 집계하여 도출됩니다:

![](https://blog.kakaocdn.net/dna/bzvSq6/btsI6PA909P/AAAAAAAAAAAAAAAAAAAAAFX9S-SICdO2TlWBhX05PM2-nLaveeFmk_oVxjZHYqr_/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1772290799&allow_ip=&allow_referer=&signature=BWzuf%2BQk1evwYqE1nJX%2FCqympMY%3D)
...
![](https://blog.kakaocdn.net/dna/sYMAZ/btsI5OphiTF/AAAAAAAAAAAAAAAAAAAAAKKsIthW-XspFyi02q-2vCzrYqL-Ww46gna8xrjFUw96/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1772290799&allow_ip=&allow_referer=&signature=qeB9UGbpreyuvwR4PQgDULhdZY0%3D)
...
![](https://blog.kakaocdn.net/dna/cdY4nQ/btsI6MxELb4/AAAAAAAAAAAAAAAAAAAAAMD5W4pAQ5g6qz5d0TDlnGlgoO2Hd5ZiG2n5J5YEhjjD/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1772290799&allow_ip=&allow_referer=&signature=0xlw5OdeoLommY3H9Yywu%2FR1lNU%3D)

그림 3: 그림 A: 녹색 표시는 하대정맥의 분지로, 좌우 총장골정맥으로 나뉩니다. 그림 B-D: 녹색 표시는 좌측 총장골정맥을 나타내며, 이는 주변의 우측 총장골동맥과 제5 요추 사이에 위치하며, 명백한 압박 협착이 없습니다.

![](https://blog.kakaocdn.net/dna/cAR495/btsI7LEpX6x/AAAAAAAAAAAAAAAAAAAAAEPtreUI7A-O12-tlmlHRRS-OYpmWw_TCzfUki9j7SnT/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1772290799&allow_ip=&allow_referer=&signature=%2FUiQJAr2muzpyqoUssBP9NZRCTk%3D)
...
![](https://blog.kakaocdn.net/dna/5l9Ht/btsI5sUiwIC/AAAAAAAAAAAAAAAAAAAAAJn9xRZ2fLPiZaoyIIfEoQBmWGqu-M0vWzLxZn2GtBdx/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1772290799&allow_ip=&allow_referer=&signature=ULWvGhVuSVpZwza4xzXyjXQ3czA%3D)
...
![](https://blog.kakaocdn.net/dna/bxNJAV/btsI6yM5i5v/AAAAAAAAAAAAAAAAAAAAACCqnULNnHITN_piMIEmcQGnTRhfDRcoT6y2smMspd3Y/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1772290799&allow_ip=&allow_referer=&signature=cz8JcaoRFNsz021DuJp9xFhcHT8%3D)

**TABLE I: MTS-CT 데이터셋에서 제안된 방법의 평가**

**D. 절제 연구(Ablation Study)**  
우리는 DEP-MHSA 모듈과 관련하여 MTS-Net의 효과를 이해하기 위해 절제 연구를 수행했습니다. **표 II**는 𝑄, 𝐾, 𝑉 행렬을 생성하기 위해 신중하게 선택된 전략과 자가 주의에서 듀얼 강화 위치 임베딩을 사용하여 위치 정보를 강화하는 DEP-MHSA 모듈이 성능을 향상시켰음을 강조합니다. 사용된 백본 네트워크는 ResNet-18 (2+1)D이며, 주의 모듈과 위치 임베딩에서 변형이 이루어졌습니다. MHSA(3D)는 [23]에서 언급된 멀티헤드 자가 주의 모듈을 나타내며, MHSA(2+1)D는 𝑄, 𝐾, 𝑉를 생성하는 제안된 방법을 사용하는 자가 주의 모듈을 의미합니다. DEP-Embedding은 주의 블록 내에서 듀얼 강화 위치 임베딩을 나타냅니다.

또한, **표 III**는 𝑄, 𝐾, 𝑉 행렬을 생성하기 위한 다양한 구성의 효과를 검증하는 또 다른 절제 연구를 보여줍니다. 이 구성에는 DEP-MHSA, DEP-MHSA-B, DEP-MHSA-C, DEP-MHSA-D가 포함됩니다. 우리의 제안된 DEP-MHSA는 다른 구성들보다 일관되게 우수한 성능을 보였으며, 이는 의료 전문가의 진단 논리를 반영한 신중하게 설계된 구조의 우월성을 강조합니다.

![](https://blog.kakaocdn.net/dna/x5sqI/btsI7OVrvnY/AAAAAAAAAAAAAAAAAAAAABM3N07y2nhPRTQXJX7BkoX9OyFZiKbSkEwCFZG2J299/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1772290799&allow_ip=&allow_referer=&signature=qN%2BNBG%2BF8KfmHhbDCbBZ%2Bwmsl7w%3D)

**TABLE II**: DEP-MHSA의 제안된 구성 요소에 대해 수행된 절제 연구 결과.

![](https://blog.kakaocdn.net/dna/lx4ob/btsI6f1hqE4/AAAAAAAAAAAAAAAAAAAAAHsDfSxYmhtEittVTnpIW-q-Ka7m1t8DSulB6qyf8VEH/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1772290799&allow_ip=&allow_referer=&signature=336L6m21W3qnQ5TPf2xtZWhoSyg%3D)

**TABLE III**: 자가 주의 모듈의 행렬을 생성하는 네 가지 구성 비교.

![](https://blog.kakaocdn.net/dna/bauBHa/btsI5uYXzXf/AAAAAAAAAAAAAAAAAAAAANYfg4d8RDtprArB997x-vRc0pnC5gMy-39l5Zhx-BDg/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1772290799&allow_ip=&allow_referer=&signature=ElcrH4vVYCy4h3yFe65ob34HARw%3D)
...
![](https://blog.kakaocdn.net/dna/s8lWL/btsI7jIpfM3/AAAAAAAAAAAAAAAAAAAAAOzrbi25uS2344bE6Y_asO5ZMYfwhvMip96F5V4-Ujkh/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1772290799&allow_ip=&allow_referer=&signature=%2Fl6CzT5AG8oTTN4cetLHArYlTx0%3D)
